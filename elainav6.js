...
const { zenzkey2 } = JSON.parse(fs.readFileSync('./zenzkey2.js'))
const { frkey } = JSON.parse(fs.readFileSync('./frkey.js'))
const { zeeone } = JSON.parse(fs.readFileSync('./zeeone.js'))
...
let limit = JSON.parse(fs.readFileSync('./storage/user/limit.json'))
...
if (budy == "bang" || budy == "Bang" || budy == "dek" || budy == "Dek" || budy == "abang" || budy == "Abang")
XeonBotInc.sendMessage(from, { text: `yaa?`, quoted: fkontak})
if (budy == "mabar" || budy == "mangbar" || budy == "Mangbar" || budy == "Mabar")
XeonBotInc.sendMessage(from, { text: `ayo saja, tpi cmn pnya roblox :v`, quoted: fkontak})
if (budy == "ahahaha" || budy == "AHAHAHA" || budy == "AHAHA" || budy == "AHAH" || budy == "ahaha" || budy == "ahaha" || budy == "yhaha" || budy == "Yhaha")
XeonBotInc.sendMessage(from, { text: `AHHAHA`, quoted: fkontak})
if (budy == "anjg" || budy == "anj" || budy == "Anjg" || budy == "ajg" || budy == "Ajg" || budy == "Kntl" || budy == "kntl" || budy == "kontol" || budy == "Kontol" || budy == "mmk" || budy == "MMK" || budy == "Mmk" || budy == "memk" || budy == "memek" || budy == "memew" || budy == "Tolol" || budy == "tolol" || budy == "tlol" || budy == "Memek" || budy == "Meki" || budy == "meki")
XeonBotInc.sendMessage(from, { text: `Shut Up, never been taught how to speak?!`, quoted: fkontak})
if (budy == "nigga" || budy == "Nigga" || budy == "ngntt" || budy == "ngntod"|| budy == "nigha" || budy == "pussy" || budy == "Pssy" || budy == "Pusi" || budy == "pusi" || budy == "pssy" || budy == "Ngentd" || budy == "ngen" || budy == "ngentd" || budy == "gblk" || budy == "gblok" || budy == "Goblok" || budy == "Goblk" || budy == "GBLK" || budy == "bego" || budy == "Bego" || budy == "asshole" || budy == "aselole" || budy == "dick" || budy == "Dick" || budy == "mfs" || budy == "mf" || budy == "Motherfucker" || budy == "motherfcker" || budy == "motherfucker" || budy == "Motherfcker" || budy == "bitch" || budy == "btch" || budy == "Bitch" || budy == "Btch")
XeonBotInc.sendMessage(from, { text: `Shut Up, never been taught how to speak?!`, quoted: fkontak})
//FAKEREPLY TROLI
const ftrol ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: botname, orderTitle: ownername, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
//FAKEREPLY TROLI
const ftroli = {
key : {
...
//FAKEREPLY VID
const fvid = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': thumb}}}
//FAKEREPLY VIDEO
const fvideo = {
key: { 
fromMe: false,
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await XeonBotInc.setStatus(`${ucapanWaktu}, type .menu to go | ${XeonBotInc.user.name} | ${xdate} Bot Runtime : ${run}`)
...
if (command) {
await XeonBotInc.sendPresenceUpdate('available', m.chat)
...
//daftar
blomdaftar = `Hai kak ${pushname} ${ucapanWaktu} \n\nSepertinya kakak belum mendaftar di database bot yah? Sebelum Menggunakan ${global.botname} Daftar Terlebih Dahulu Ya Dengan Cara Ketik .daftar Lalu Kirim ^^`
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
                let user = global.db.data.users[m.sender]
...
yag = await getBuffer(anu.url)
XeonBotInc.sendMessage(m.chat, { image: yag, caption: mess.success }, { quoted: fkontak})
break
case 'mori': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=mori-calliope`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak)
break
case 'waifu2': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=waifu`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak)
break
case 'nloli': 
...
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak})
break
case 'cum':
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
axios.get(`https://elaina-rest-api.herokuapp.com/api/nsfw/cum?apikey=elaina`)
.then(({data}) => {
XeonBotInc.sendImage(m.chat, data.url, mess.success, fkontak)
})
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
axios.get(`https://api.lolhuman.xyz/api/random2/cum_jpg?apikey=${lolkey}`)
.then(({data}) => {
XeonBotInc.sendImage(m.chat, data.url, mess.success, fkontak)
})
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/ahegao?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'shota2': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/shota?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'ryouiki': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/ryouiki?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kobo': case 'kanaeru': case 'kobo-kanaeru':
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/kobo?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'zeta': case 'vestia': case 'vestia-zeta':
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/zeta?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'things': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/thighs?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hgirls': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/gifs?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hloli': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/nsfwloli?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'twitter': 
if (!isRegister) return reply(blomdaftar)
...
if (isBanChat) return reply(mess.banChat)
reply(`Url Ditemukan
Perintah yang dapat anda kirimkan
tweetvid [url] untuk mendapatkan video
tweetimg [url] untuk mendapatkan image`)
break
case 'tweetvid':
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/downloader/twittervid?url=${q}&apikey=elaina`)
res = await getBuffer(anu.result)
XeonBotInc.sendMessage(m.chat, { video: res, caption: mess.success }, { quoted: fkontak }).catch((err) => reply(`Maaf, url tidak ditemukan!`))
break
case 'tweetimg':
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!q) return reply(`Where's the link?`)
reply(mess.wait)
anu = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/downloader/twitterimg?url=${q}&apikey=elaina`)
res = await getBuffer(anu.result)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak }).catch((err) => reply(`Maaf, url tidak ditemukan!`))
break
case 'oral': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/oral?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'milf': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/milf?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'paizuri': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/paizuri?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'trap2': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/trap?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'waifu4': 
if (!isRegister) return reply(blomdaftar)
...
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/waifu?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'ppcouple2': case 'couplepp2': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await fetchJson(`https://zenzapis.xyz/randomanime/couples?apikey=${zenzkey2}`)
mek = anu.result
XeonBotInc.sendMessage(m.chat, { image: mek.male, caption: `Couple Male🙎🏻‍♂️` }, { quoted: fkontak})
XeonBotInc.sendMessage(m.chat, { image: mek.female, caption: `Couple Female🙎🏻‍♀️` }, { quoted: fkontak}).catch((err) => reply(`Maaf, Apikey mu telah mencapai batas`))
break
case 'thighs': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/thighs?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'pussy': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/pussy?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'orgy': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/orgy?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hmanga': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/manga?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'maid': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/maid?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'netorare': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/netorare?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'jahy': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/jahy?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cuckold': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/cuckold?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hass': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/ass?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'yuri': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/yuri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kitsune': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/kitsune?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'hentai': 
if (!isRegister) return reply(blomdaftar)
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/hentai?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'futanari': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/futanari?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'anal': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/anal?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'tentacles': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/tentacles?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Gagal mendapatkan foto!`))
break
case 'glasses': 
if (!isRegister) return reply(blomdaftar)
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/glasses?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'zettai': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/zettai?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'bdsm': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/bdsm?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'bj': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/bj?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'blowjob': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/blowjob?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'girlsolo': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/girl-solo?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'tits': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/tits?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'foot': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/foot?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'feet': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/feet?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'erofeet': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/erofeet?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'femdom': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/femdom?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'gangbang': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/gangbang?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'lesbians': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/lesbian?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cumsluts':
if (!isRegister) return reply(blomdaftar) 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/cumsluts?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kemonomimi': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/kemonomimi?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kuni': 
if (!isRegister) return reply(blomdaftar)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/kuni?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'boobs': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/masturbation?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'nsfwwall': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/mobilewall?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hneko': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/neko?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'sfwneko': 
if (isBan) return reply(mess.ban)	 			
...
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/neko2?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'panties': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/panties?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'trap': 
if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(m.chat, { image: anu.url, caption: mess.success }, { quoted: fkontak})
break
case 'nwaifu': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/random/darkpfp?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cecanindo': case 'cecanindonesia': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/indonesia?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'meme': case 'mim': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://danzzapi.xyz/api/random/meme?apikey=danzz`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'hijab': case 'hijaber': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://danzzapi.xyz/api/cogan/random?apikey=danzz`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'asupan':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/asupantiktok?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecan':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/cecan?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecan2':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/cecan?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kpop':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/kpop?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'santai': case 'santuy': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://danzzapi.xyz/api/asupan/santuy?apikey=danzz`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'bocil': case 'bocah': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://danzzapi.xyz/api/asupan/bocil?apikey=danzz`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'ukhty': case 'ughtea': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://danzzapi.xyz/api/asupan/ukhty?apikey=danzz`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cecankorea': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/korea?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cecanjepang': case 'cecanjapan': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/japan?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cecanmalay': case 'cecanmalaysia': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/malaysia?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cecanchina': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/china?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecanthailand': 
if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecanvietnam': case 'cecanviet': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/vietnam?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kayes': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/notnot?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'marin': 
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
	iyain = await fetchJson(`https://zenzapis.xyz/randomanime/hololive?apikey=${zenzkey2}`)
	res = iyain.result
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/megumin?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'uniform': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/uniform?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'raiden': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/raiden-shogun?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cosplay': 
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/random/cosplay?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'wallnime': 
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/anime/sfw/avatar?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'certyt': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/ephoto/ytcertificate?text=${text}&apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'logogirl': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Example : ${prefix}${command} Kelly`)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/ephoto/logogirl?text=${text}&apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'freefire': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Example : ${prefix}${command} Kelly`)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/ephoto/ffcover?text=${text}&apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'nuliskanan': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Example : ${prefix}${command} Kelly`)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/creator/nuliskanan?text=${text}&apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'nuliskiri': 
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomanime/selfies?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'waifuava': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/anime/sfw/waifu?apikey=${zenzkey2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'husbu': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/nsfw/ero?apikey=elaina`)
XeonBotInc.sendImage(m.chat, anu, mess.success, fkontak)
break
case 'nyuri': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/yuri?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak})
break
   case 'spank':
      if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/waifu`)
             XeonBotInc.sendImage(m.chat, waifudd, mess.success, { quoted:fkontak }).catch(err => {
                    return('Error!')
                })
break
case 'animecuddle':
...
if (!q) return reply("Where's text?")
var nyz = `https://pecundang.herokuapp.com/api/memegen1?teks=${q}&img_url=${mem}`
memek = await XeonBotInc.sendImageAsSticker(m.chat, nyz, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
if (command == 'meme2' || command == 'smeme2' || command == 'memegen2') {
if (!q1 && !q2) return reply("Where's text1|text2 ?")
var nyz = `https://pecundang.herokuapp.com/api/memegen2?teks1=${q1}&teks2=${q2}&img_url=${mem}`
memek = await XeonBotInc.sendImageAsSticker(m.chat, nyz, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
if (command == 'meme3' || command == 'smeme3' || command == 'memegen3') {
if (!q) return reply("Where's Text?")
var nyz = `https://pecundang.herokuapp.com/api/memegen3?teks=${q}&img_url=${mem}`
memek = await XeonBotInc.sendImageAsSticker(m.chat, nyz, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
...
const isBanCtRevoke = dataBanCtRevoke.includes(m.sender) ? true : false
const argz = body.split(' ')
if (argz.length === 1) return m.reply(`Penggunaan fitur antidelete :\n\n*${prefix}antidelete [aktif/mati]* (Untuk grup)\n*${prefix}antidelete [ctaktif/ctmati]* (untuk semua kontak)\n*${prefix}antidelete banct 628558xxxxxxx* (banlist kontak)`)	
if (argz[1] == 'aktif') {
				
					if (m.isGroup) {
						if (isRevoke) return m.reply(`Antidelete telah diaktifkan di grup ini sebelumnya!`)
						
						dataRevoke.push(from)
						
						fs.writeFileSync('./src/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
						
						m.reply(`*Succes Enable Antidelete Grup!*`)
						
					} else if (!m.isGroup) {
					
						m.reply(`Untuk kontak penggunaan *${prefix}antidelete ctaktif*`)
					...
					if (!m.isGroup) {
						...
						if (isCtRevoke) return m.reply(`Antidelete telah diaktifkan di semua kontak sebelumnya!`)
						
						dataCtRevoke.data = true
						
						fs.writeFileSync('./src/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
						
						m.reply(`Antidelete diaktifkan disemua kontak!`)
						
					} else if (m.isGroup) {
					
						m.reply(`*Untuk grup penggunaan *${prefix}antidelete aktif*`)
						
					}
					
				} else if (argz[1] == 'banct') {
				
					if (isBanCtRevoke) return m.reply(`kontak ini telah ada di database banlist!`)
					
					if (argz.length === 2 || argz[2].startsWith('0')) return m.reply(`Masukan nomer diawali dengan 62! contoh 62859289xxxxx`)
					
					dataBanCtRevoke.push(argz[2] + '@s.whatsapp.net')
					
					fs.writeFileSync('./src/ct-revoked-banlist.json', JSON.stringify(dataBanCtRevoke, null, 2))
					
					m.reply(`Kontak ${argz[2]} telah dimasukan ke banlist antidelete secara permanen!`)
					...
					if (m.isGroup) {
						...
						m.reply(`*Succes disable Antidelete Grup!*`)
						
					} else if (!m.isGroup) {
					
						m.reply(`*Untuk kontak penggunaan *${prefix}antidelete ctmati*`)
					...
					if (!m.isGroup) {
						...
						m.reply(`Antidelete dimatikan disemua kontak!`)
						
					} else if (m.isGroup) {
					
						m.reply(`*Untuk grup penggunaan *${prefix}antidelete mati*`)
...
case 'autosw': {
if (!isCreator) return replay(mess.owner)
if (XeonBotInc.autosw) {
XeonBotInc.autosw = false
m.reply('auto sw is now disabled')
} else if (!XeonBotInc.autosw) {
XeonBotInc.autosw = true
m.reply('auto sw is now active')
}
} 
break
case 'daftar':
  if (isRegister) return reply('Your account is already registered in the database')
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
	if (m.isGroup) return reply('Register in private message please')
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
const serialUser = createSerial(18)
try {
ppimg = await XeonBotInc.profilePictureUrl(`${m.sender.split('@')[0]}@c.us`)
} catch {
ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
anuuh = (`*「 𝙑𝙀𝙍𝙄𝙁𝙄𝘾𝘼𝙏𝙄𝙊𝙉 𝙎𝙐𝙆𝙎𝙀𝙎  」*
*Thank you for getting yourself into the database ${global.botname} here is the info*\n\n*●Name : ${pushname}*\n*●Number : ${m.sender.split('@')[0]}*\n*●Users : ${register.length}*\n*●SN : ${serialUser}*\n\n*Use bot properly*\n_Type menu for menu info, type allmenu for all features_\n\n*_--------------------------------------_*${global.rules}`)
register.push(m.sender)
fs.writeFileSync('./storage/user/register.json', JSON.stringify(register))
Imgnah = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlaKCZE6A9OdzmLHnsxL28_XT8qjBsL1tSlg&usqp=CAU`)
XeonBotInc.sendImage(m.chat, Imgnah, anuuh, fkontak)
  break
case 'fitnah':
if (!m.isGroup) return replay(mess.group)
...
XeonBotInc.sendMessage(from, { text: bot, mentions: mentioned }, { quoted: fkontakens.length > 2 ? msg1 : msg2 })
break
case 'jadibot': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/cogan?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kurumi':
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
					...
					break
					case 'spongebob': case 'sponsbob': case 'spongbob':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/sponsbob?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
					case 'jiso': case 'jisoo': case 'jisyo':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/jisoo?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
					case 'cat': case 'meong': case 'kucing':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/kucing?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
					case 'lonte': case 'lonteh': case 'lontay':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/lonte?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
					case 'menjamet': case 'memejamet': case 'jamet':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/menjamet?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
					case 'manusialidi': case 'lidi':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
					anu = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/manusia-lidi?apikey=${zeeone}`)
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Sorry, Failed to send image'))
					break
...
if (isBanChat) return reply(mess.banChat)
                ...
                images = n[Math.floor(Math.random() * n.length)].url
                        XeonBotInc.sendMessage(m.chat, { image: images, caption: mess.success }, { quoted: fkontak})
                })
                }
                break
case 'loli-waifu':
...
teks = "yhaha hayyuk"
XeonBotInc.sendMessage(m.chat, { image : { url : funne }, caption: teks }, { quoted : fkontak })
}
break
      case 'rules':
            XeonBotInc.sendMessage(from, { text: global.rules, quoted: fkontak})
             break
       case 'caklontong':{
...
_▸ Link : https://chat.whatsapp.com/${response}_
`
m.reply(teks)
break
case 'hiya':{
...
break
		case 'alquran': {
			if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		if (!args[0]) throw `Example : ${prefix}${command}1 2`
		if (!args[1]) throw `Example : ${prefix}${command}1 2`
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		XeonBotInc.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : fkontak })
		}
		break
		case 'tafsirsurah': {
			if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
		...
		XeonBotInc.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fkontak}).catch ((err) => m.reply(oh))
		}
		break
case 'alkitab': {
if (isBan) return reply(mess.ban)	 			
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) throw `Example : ${prefix}${command} murder in my mind`
let jad = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/music/joox?query=${q}&apikey=elaina`)
jadres = jad.result
song = jadres.lagu
album = jadres.album
artist = jadres.penyanyi
publish = jadres.publish
img = await getBuffer(jadres.img)
reslir = jad.lirik
lirik = reslir.result
gen = (`「 *Joox Search* 」
*Song* : ${song}
...
*Publish* : ${publish}
*Lyrics* : ${lirik}`)
XeonBotInc.sendImage(m.chat, img, gen, fkontak)
}
break
case 'ttstalk': {
if (!isRegister) return reply(blomdaftar)
...
XeonBotInc.sendImage(m.chat, diswah, mess.success, { quoted: fkontak })
break
case 'calculator':
case 'calc':
case 'kalkulator':
...
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : fkontak })
}
break
case 'tomp3': {
   if (isBan) return reply(mess.ban)	 			
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${XeonBotInc.user.name} (${m.id}).mp3`}, { quoted : fkontak })
}
break
...
break
	    ...
	    XeonBotInc.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : fkontak })
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            if (!text) return reply(`Example : ${prefix + command} love`)
            yowaimo = await fetchJson(`https://api.lolhuman.xyz/api/drakor?apikey=${lolkey}&query=${text}`)
		    mek = yowaimo.result
			gambar = await getBuffer(mek.thumbnail)
            capt = `Drakor Search From : ${text}
${themeemoji} Title: ${mek.title}
${themeemoji} Duration: ${mek.duration}
${themeemoji} Casts: ${mek.casts}
${themeemoji} Genre: ${mek.genre}
${themeemoji} Url: ${mek.link}
${themeemoji} Synopsis: ${mek.synopsis}
${themeemoji} Thumbnail Url: ${mek.thumbnail}`
            XeonBotInc.sendImage(m.chat, gambar, capt, fkontak)
			}
            break
            case 'animexxx':{
            	   if (isBan) return reply(mess.ban)	 			
...
teks = "\nDarkjokes*"
XeonBotInc.sendMessage(m.chat, { image : { url : res }, caption: teks }, { quoted : fkontak })
break
case 'cnn-news':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
teks += "══════════════════"
XeonBotInc.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted : fkontak })
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `${anu.title}`}, { quoted : fkontak }).catch((err) => reply(mess.error))
...
*Link* : ${baby1[0].link}`
reply(`${result4}`)
XeonBotInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : fkontak }).catch ((err) => reply(mess.error))
}
break
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : fkontak })
                fs.unlinkSync(ran)
                })
...
break
           case 'bot': case 'P': case 'ping': case 'botstatus': case 'statusbot': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!isRegister) return reply(blomdaftar)
const mekik4 = fs.readFileSync('./XeonMedia/image/menuacc.jpg')
const m3k = fs.readFileSync('./XeonMedia/video/idfc2.mp4')
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
                `).trim()
                XeonBotInc.sendMessage(m.chat, { video: m3k , caption: respon }, { quoted: fkontak })
				await sleep(1500)
...
teksss = (`*「 ${global.botname} Script and Donate 」*

*_Group WhatsApp : ${groupwea}_*
*_GitHub Script : ${global.botscript}_*

 
*_Dana : ${global.allpay} | ${global.allpay2}_*
*_Gopay : ${global.allpay} | ${global.allpay2}_*
*_OVO : ${global.allpay} | ${global.allpay2}_*
*_Pulsa : ${global.allpay} | ${global.allpay2}_*
*_Saweria : ${global.saweria}_*
...
${global.rules}`)
  XeonBotInc.sendMessage(m.chat, { video: anjay , caption: kocak }, { quoted: fkontak })
  await sleep(1000)
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            break
case 'allmenu':
const m3k = fs.readFileSync('./XeonMedia/video/jojo.mp4')
...
if (!isRegister) return reply(blomdaftar)
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
kocak2 = (`_*Hello ${m.pushName} 👋.*_
_*🇬🇧 : List all features*_.
_*🇮🇩 : Daftar semua fitur*_.
_*🇯🇵 : このボットの機能のリスト*_.

*[   INFORMATION   ]*
_⫹⫺ Your Name : ${m.pushName}_
_⫹⫺ Registered : ${isRegister ? '✔️' : `No`}_
_⫹⫺ Bot Name : ${global.botname}_
_⫹⫺ Library : RisKy-Sz_
_⫹⫺ Version : 4.4.4_
_⫹⫺ Language : 𝐑. 𝐒𝐙_
_⫹⫺ Recoder : ${global.ownername}_
_⫹⫺ Server ID : ${global.groupbot}_
_⫹⫺ Date Server :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}_
_⫹⫺ Time Sever : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}_                
_⫹⫺ Bot Mode : ${XeonBotInc.public ? 'Public' : `Self`}_
_⫹⫺ Connected : 4K Sanzz+_

╔═══════✪「 OWNER 」	
╠${sp} ${prefix}shutdown
╠${sp} ${prefix}restart
╠${sp} ${prefix}autosw
╠${sp} ${prefix}antidelete
╠${sp} ${prefix}self
╠${sp} ${prefix}jadibot
╠${sp} ${prefix}spamcall
...
╠${sp} ${prefix}tweetvid [url]
╠${sp} ${prefix}tweetimg [url]
...
╠${sp} ${prefix}smeme1 [text]
╠${sp} ${prefix}smeme2 [text1|text2]
╠${sp} ${prefix}smeme3 [text]
...
╠${sp} ${prefix}cecanmalaysia
╠${sp} ${prefix}cecankorea
╠${sp} ${prefix}cecanjapan
╠${sp} ${prefix}kayes
╠${sp} ${prefix}notnot
╠${sp} ${prefix}bts
╠${sp} ${prefix}woof
...
│For helping me adding all of this features
└─────────────┈ ⳹`)
XeonBotInc.sendMessage(m.chat, { video: m3k , caption: kocak2 }, { quoted: fkontak })
await sleep(1000)
